...
export default function Home() {
  const btnData = [
    ...
    {
      text: "ارسال پیام در واتس اپ",
      link: "https://api.whatsapp.com/send?phone=989123654022",
    },
      ...
      >
        ...
        >
          <Typography
            ...
            sx={{
              background:
                "linear-gradient(to top, rgb(191, 157, 97), rgb(246, 216, 140))",
              backgroundClip: "text",
        ...
        <Grid item xs={12}>
          <Box component={"img"} src="/line.svg" />
        </Grid>
        ...
        >
          {btnData.map((x, index) => (
            <Link
              key={index}
              style={{ width: "280px", marginBlock: "4px" }}
              href={x.link}
            >
              <Button
                disableElevation
